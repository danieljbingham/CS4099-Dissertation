...
export const SHORTLIST_TAGGED_SEARCH_URL = API_PATH + "/shortlist/search/getShortlistTagged";
export const SHORTLIST_STATUS_SEARCH_URL = API_PATH + "/shortlist/search/getShortlistStatus";
